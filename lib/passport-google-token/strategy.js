...
GoogleTokenStrategy.prototype.userProfile = function (accessToken, done) {
  this._oauth2.get("https://www.googleapis.com/oauth2/v1/userinfo", accessToken, function (
    err,
    body,
    res
  ) {
    ...
    try {
       ...
       *   "verified_email": true,
       *   "name": "Ali Eskandarpour",
       *   "given_name": "Ali",
       *   "family_name": "Eskandarpour",
       *   "picture": "https://lh3.googleusercontent.com/a-/AOh14GjQ1gxYKT3Ie86r_SAsIueVfIagwxpVd1uNGkMdsg",
       *   "locale": "en"
       * }
       */
